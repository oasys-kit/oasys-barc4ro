...
# coding: utf-8
###################################################################################
# barc4RefractiveOptics - example A - error profile generated from the Zernike fit from Example 2
...
if __name__ == '__main__':
    print()
    print('barc4RefractiveOptics example #3A:')
    print('Gaussian beam propagation through a 7-element Be CRL followed by an error profile from a Zernike fit'
          'of the errors in Example 2')
    print()
    ...
    # Generating "on the fly"  the error surface

    Zcoeffs = [-0.01044743*1E-6,  0.50879194*1E-6,  0.63254266*1E-6,  0.15158244*1E-6,  0.03402569*1E-6, -0.93969054*1E-6,
                -0.89744169*1E-6,  2.87278068*1E-6, 1.97525395*1E-6,  0.45456465*1E-6,  4.29877665*1E-6,  0.49336526*1E-6,
                 0.33792639*1E-6,  0.23653832*1E-6, -0.3942894*1E-6,   1.1086058*1E-6,  -0.26454858*1E-6,  0.54312049*1E-6,
                -0.14353761*1E-6,  0.64135356*1E-6, 0.96499569*1E-6,  1.19964751*1E-6, -0.53687009*1E-6,  0.36028251*1E-6,
                -0.03538416*1E-6,  0.28508147*1E-6,  0.07216373*1E-6,  0.68777689*1E-6, -0.22850751*1E-6,  0.23591547*1E-6,
                -0.53726614*1E-6, -0.19528177*1E-6, -0.21030707*1E-6,  0.39807618*1E-6,  0.07020875*1E-6,  0.65286645*1E-6,
                1.63981458*1E-6]
    oeCRL_Error = b4RO.srwl_opt_setup_CRL_errors(_z_coeffs=Zcoeffs, _pol='c', _delta=delta, _atten_len=attenuation_length,
                                                 _apert_h=CRLAph, _apert_v=CRLApv, _xc=0, _yc=0, _nx=2001, _ny=2001)

    print('Zernike coefficients (um): \n' + str(asarray(Zcoeffs) * 1e6))
