...
# coding: utf-8
###################################################################################
# barc4RefractiveOptics - example B - error profile generated from "on the fly" with a random set of polynomials with
# rms size limited by a constant
...
if __name__ == '__main__':
    print()
    print('barc4RefractiveOptics example #3B:')
    print('Gaussian beam propagation through a 7-element Be CRL followed by an error profile error generated "on the fly" '
          'with a random set of polynomials with rms size limited by a constant')
    print()
    ...
    # Generating "on the fly"  the error surface with a random set of polynomials with rms size given limited to 5um

    oeCRL_Error = b4RO.srwl_opt_setup_CRL_errors(_z_coeffs=1.5e-6, _pol='c', _delta=delta, _atten_len=attenuation_length,
